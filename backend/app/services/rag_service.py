...
- 关于学习情况、能力水平、薄弱环节、闯关进度等问题，应判断为clear（系统有用户画像数据可以回答）
...
class RAGService:
    ...
    async def chat(
        ...
        is_profile_query = self._is_profile_related(message)
    ...
    def _is_profile_related(self, message: str) -> bool:
        keywords = [
            '学习情况', '能力', '薄弱', '闯关', '进度', '画像', '学习风格',
            '错误模式', '擅长', '不擅长', '建议学', '推荐学', '下一步学',
            '我的水平', '我的成绩', '我的能力', '学习状态', '学习数据',
            '通关', '徽章', '连续学习', '学习时长', '能力值', '能力评分',
        ]
